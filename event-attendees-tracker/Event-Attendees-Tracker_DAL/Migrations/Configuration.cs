namespace Event_Attendees_Tracker_DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Event_Attendees_Tracker_DAL.Database_Context.EAT_DBContext>
    {
        ...
        protected override void Seed(Event_Attendees_Tracker_DAL.Database_Context.EAT_DBContext context)
        {
            ...
            defaultUserDetails.Add(new UserDetails() { UserUID = 560258, FirstName = "Jitender", LastName = "Rajput", EmailID = "jkrajput24@gmail.com", Password = "mydesire", CreatedBy = 1, CreatedDate = System.DateTime.Now, UpdatedBy = 1, UpdatedDate = System.DateTime.Now, Role = context.Master_DBRoles.FirstOrDefault(role => role.RoleName.Equals("Organizer")) });
